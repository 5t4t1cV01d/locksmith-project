...
<section class="contact-section" id="contacto">
    ...
    <div class="contact-content-wrapper">
        <?php if (isset($_GET['status'])): ?>
            <div
                class="status-alert <?php echo ($_GET['status'] == 'success_opinion') ? 'success' : 'error'; ?> animate-slide contact-alert">
                <?php
        ...
        <div class="contact-form-wrapper" id="form-content">
            <p class="form-instruction">¿Cómo fue tu experiencia con <strong>LA GANZUA</strong>? Tu opinión nos ayuda a
                seguir brindando un servicio de excelencia en Mérida.</p>
            ...
            <form id="opinion-form" action="php/guardar_opinion.php" method="POST">
                ...
                <div class="form-group-inline" data-layout="half-half">
                    ...
                    <div class="form-group half-width">
                        ...
                        <input type="text" id="ubicacion" name="ubicacion" placeholder="Ej. Mérida Centro / Caucel"
                            required>
                    </div>
                </div>
                ...
                <div class="info-columns-wrapper">
                    ...
                    <div class="info-column left-half">
                        ...
                        <div class="contact-items-wrapper">
                            ...
                            <div class="info-item">
                                ...
                                <p>Email: <strong>LAGANZUA@gmail.com</strong></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-column right-half">
                        ...
                        <div class="social-links">
                            ...
                            <a href="https://www.linkedin.com/in/gabriel-ernesto-tamayo-154016398/" target="_blank"
                                title="LinkedIn"><img src="img/icons/linkedin.svg" alt="LinkedIn"></a>
                        </div>
                    </div>
                </div>
            </div>
